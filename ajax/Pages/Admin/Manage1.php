...
if (mysqli_num_rows($result) > 0) {
    ...
    while($row = mysqli_fetch_assoc($result)) 
    {
		...
		if ($UserBanned == 0) {
    	 ...
    	 echo "<tr class='$UserUID'>
		    	 <td>$UserUID</td>
		    	 <td>
                    <select class='UserTypeUID$UserUID' disabled='true'>
                        <option value='' selected disabled>$UserTypeUID</option>
				 ...
				 <td>
                    <select class='UserYear$UserUID' disabled='true'>
                        <option value='' selected disabled>$UserYear</option>
		    	 ...
		    	 <td>
                    <select class='UserCampus$UserUID' disabled='true'>
                        <option value='' selected disabled>$UserCampus</option>
                        <option value='1'>Canterbury</option>
                        <option value='2'>Medway</option>
                    </select>
                 </td>
		    	
				 <td><button value='$UserUID' class='DUser $UserUID' id='Infobutton1'>Remove User</button></td>
				 <td><button value='$UserUID' class='EUser $UserUID' id='Infobutton2'>Edit User</button></td>
